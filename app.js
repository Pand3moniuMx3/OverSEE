...
document.addEventListener('DOMContentLoaded', function () {
    ...
    navToggle.addEventListener('click', function () {
        ...
        blurBackground.style.display = navMenu.classList.contains('show') ? 'block' : 'none';
    });
...
document.addEventListener('DOMContentLoaded', function() {
  const firstContainerButton = document.querySelector('.left-service-button');
  const secondContainerButton = document.querySelector('.right-service-button');
  const sliderRow = document.getElementById('service-slider-row');

  if (!firstContainerButton || !secondContainerButton || !sliderRow) {
  ...
  firstContainerButton.addEventListener('click', function() {
      console.log('First button clicked');
      sliderRow.style.transform = 'translateX(50%)';
  });

  secondContainerButton.addEventListener('click', function() {
      console.log('Second button clicked');
      sliderRow.style.transform = 'translateX(-50%)';
  });

  // Adjust the sliderRow width dynamically
  function updateSliderWidth() {
      const containerWidth = document.querySelector('.left-content-container').offsetWidth;
      sliderRow.style.width = `${containerWidth * 2}px`;
      console.log('Slider width updated:', sliderRow.style.width);
  }
